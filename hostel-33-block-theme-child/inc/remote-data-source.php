...
// Ensure the HttpDataSource class is loaded (adjust the path as needed)
if (! class_exists('\RemoteDataBlocks\Config\DataSource\HttpDataSource')) {
}
...
// Ensure the classes are loaded before use.
if (! class_exists('\RemoteDataBlocks\Config\DataSource\HttpDataSource') || ! class_exists('\RemoteDataBlocks\Config\Query\HttpQuery')) {
  return;
} else {
