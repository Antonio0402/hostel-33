...
if (! function_exists('hostel_33_scripts')) {
  ...
  function hostel_33_scripts()
  {
    ...
    wp_enqueue_script('hostel-33-swiper', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-element-bundle.min.js', array(), GENERATE_VERSION, false);

    wp_enqueue_script('hostel-33-main-script', get_stylesheet_directory_uri() . '/build/main.js', array('hostel-33-swiper', 'jquery'), time(), true);
