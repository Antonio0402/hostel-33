 ...
 *
 * Parent Theme:
 * require_once $child_theme_dir . '/path/to/class-tgm-plugin-activation.php';
 *
 * Child Theme:
...
require_once $child_theme_dir . '/inc/class-tgm-plugin-activation.php';
...
function hostel_33_register_required_plugins()
{
  ...
  $plugins = array(
    ...
    array(
      ...
      'source'             => $child_theme_dir . '/plugins/view-count.zip', // The plugin source.
    ...
    array(
      ...
      'source'             => $child_theme_dir . '/plugins/wp-content/plugins/all-in-one-contact-buttons-wpshare247-pro.zip', // The plugin source.
      'required'           => true, // If false, the plugin is only 'recommended' instead of required.
      'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
      'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
      'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
